classdef EPO4figure
    ...
    methods(Static = true)
        function obj = EPO4figure()
            ...
            grid(gca,'minor')
            gui.state = uicontrol('Style', 'text',...
                     'String', gui.data.names.state,...
                     'Position', [20 120 50 20],...
                     'HorizontalAlignment','left');
            gui.stated = uicontrol(   'Style','edit',...
                                    'String', gui.data.state,...
                                    'Position', [70 120 50 20]);
            gui.bat = uicontrol('Style', 'text',...
                     'String', gui.data.names.bat,...
                     'Position', [20 100 50 20],...
                     'HorizontalAlignment','left');
            gui.batd = uicontrol(   'Style','edit',...
                                    'String', gui.data.bat,...
                                    'Position', [70 100 50 20]);
            gui.hdg = uicontrol('Style', 'text',...
                     'String', gui.data.names.hdg,...
                     'Position', [20 80 50 20],...
                     'HorizontalAlignment','left');
            gui.hdgd = uicontrol(   'Style','edit',...
                                    'String', gui.data.hdg,...
                                    'Position', [70 80 50 20]);
            gui.xpos = uicontrol('Style', 'text',...
                     'String', gui.data.names.xpos,...
                     'Position', [20 60 50 20],...
                     'HorizontalAlignment','left');
            gui.xposd = uicontrol(  'Style','edit',...
                                    'String', gui.data.xpos,...
                                    'Position', [70 60 50 20]);
            gui.ypos = uicontrol('Style', 'text',...
                     'String', gui.data.names.ypos,...
                     'Position', [20 40 50 20],...
                     'HorizontalAlignment','left');
            gui.yposd = uicontrol(  'Style','edit',...
                                    'String', gui.data.ypos,...
